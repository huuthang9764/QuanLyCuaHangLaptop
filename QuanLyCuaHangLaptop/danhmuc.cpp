...
void XuatDanhSachThuongHieu(const DanhSachThuongHieu& dsth) {
    if (dsth.soLuong == 0) {
        cout << "Chua co Thuong Hieu nao trong danh sach." << endl;
        return;
    }
    ...
    for (int i = 0; i < dsth.soLuong; i++) {
        cout << "| " << left << setw(10) << dsth.ds[i].maThuongHieu
             << "| " << left << setw(20) << dsth.ds[i].tenThuongHieu
             << "| " << left << setw(15) << dsth.ds[i].quocGia << " |" << endl;
    }
    cout << "------------------------------------------------------" << endl;
}
...
void XuatDanhSachLoai(const DanhSachLoai& dsl) {
    if (dsl.soLuong == 0) {
        cout << "Chua co Loai San Pham nao trong danh sach." << endl;
        return;
    }
    ...
    for (int i = 0; i < dsl.soLuong; i++) {
        cout << "| " << left << setw(10) << dsl.ds[i].maLoai
            << "| " << left << setw(30) << dsl.ds[i].tenLoai << " |" << endl;
    }
    cout << "---------------------------------------------" << endl;
}
