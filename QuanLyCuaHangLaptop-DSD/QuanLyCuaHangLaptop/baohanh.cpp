...
// =================== CHỨC NĂNG TRA CỨU (ARRAY VERSION) ===================
...
void TraCuuBaoHanhTheoSerial(const DanhSachBaoHanh& dsBH) {
    ...
    if (found) cout << ">> XAC NHAN: DAY LA SAN PHAM DO CUA HANG BAN RA.\n";
    else cout << ">> CANH BAO: Khong tim thay serial nay trong he thong!\n";
}
...
void MenuQuanLyBaoHanh(DanhSachBaoHanh& dsBH) {
    ...
    do {
        ...
        system("cls");
        switch (luaChon) {
        case '1': TraCuuBaoHanhTheoSerial(dsBH); break;
        case '2': TraCuuBaoHanhTheoKhachHang(dsBH); break;
        case '3': TraCuuBaoHanhTheoMaLaptop(dsBH); break;
        case '4': XuatTatCaBaoHanh(dsBH); break;
        case '0': break;
